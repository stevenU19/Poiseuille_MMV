...
Estos comandos generan el siguiente ejecutable:
...
Y luego se ejecuta el script de benchmark:
...
Como parte del trabajo de grado titulado: “Análisis de la portabilidad de la implementación de métodos numéricos de hidrodinámica de partículas suaves en diferentes plataformas y frameworks CPU/GPU”.
